...
namespace CRUD_LINQ {
    ...
    public partial class GestionPedidosDataSet : global::System.Data.DataSet {
        ...
        public partial class EmpleadoDataTable : global::System.Data.TypedTableBase<EmpleadoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmpleadoRow AddEmpleadoRow(EmpresaRow parentEmpresaRowByEmpresaFK, string Nombre, string Apellido) {
                ...
                if ((parentEmpresaRowByEmpresaFK != null)) {
                    columnValuesArray[1] = parentEmpresaRowByEmpresaFK[0];
                }
...
namespace CRUD_LINQ.GestionPedidosDataSetTableAdapters {
    ...
    public partial class CargoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_LINQ.Properties.Settings.Default.ConexionEmpresa;
        }
    ...
    public partial class CargoEmpleadoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[CargoEmpleado] WHERE (([Id] = @Original_Id) AND ([IdEmpleado] " +
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CargoEmpleado] ([IdEmpleado], [IdCargo]) VALUES (@IdEmpleado, " +
                "@IdCargo);\r\nSELECT Id, IdEmpleado, IdCargo FROM CargoEmpleado WHERE (Id = SCOPE_" +
                "IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[CargoEmpleado] SET [IdEmpleado] = @IdEmpleado, [IdCargo] = @IdCargo WHERE (([Id] = @Original_Id) AND ([IdEmpleado] = @Original_IdEmpleado) AND ([IdCargo] = @Original_IdCargo));
SELECT Id, IdEmpleado, IdCargo FROM CargoEmpleado WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, IdEmpleado, IdCargo FROM dbo.CargoEmpleado";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
    ...
    public partial class EmpleadoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Empleado] WHERE (([Id] = @Original_Id) AND ([IdEmpresa] = @Ori" +
                "ginal_IdEmpresa) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_A" +
                "pellido))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Empleado] ([IdEmpresa], [Nombre], [Apellido]) VALUES (@IdEmpre" +
                "sa, @Nombre, @Apellido);\r\nSELECT Id, IdEmpresa, Nombre, Apellido FROM Empleado W" +
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Empleado] SET [IdEmpresa] = @IdEmpresa, [Nombre] = @Nombre, [Apellido] = @Apellido WHERE (([Id] = @Original_Id) AND ([IdEmpresa] = @Original_IdEmpresa) AND ([Nombre] = @Original_Nombre) AND ([Apellido] = @Original_Apellido));
SELECT Id, IdEmpresa, Nombre, Apellido FROM Empleado WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, IdEmpresa, Nombre, Apellido FROM dbo.Empleado";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_Id, int Original_IdEmpresa, string Original_Nombre, string Original_Apellido) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int IdEmpresa, string Nombre, string Apellido) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int IdEmpresa, string Nombre, string Apellido, int Original_Id, int Original_IdEmpresa, string Original_Nombre, string Original_Apellido, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int IdEmpresa, string Nombre, string Apellido, int Original_Id, int Original_IdEmpresa, string Original_Nombre, string Original_Apellido) {
            return this.Update(IdEmpresa, Nombre, Apellido, Original_Id, Original_IdEmpresa, Original_Nombre, Original_Apellido, Original_Id);
        }
    }
